...
export DATA_PATH=/media/data/yassir/datasets/downloads/data/wikipedia_split/psgs_w100.tsv
export OUTPUT_DIR=/media/data/yassir/datasets/downloads/data/wikipedia_split_tokenized_truncated_with_title
export NUM_PROC=65
